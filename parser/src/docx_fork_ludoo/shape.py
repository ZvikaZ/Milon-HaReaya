...
from docx_fork_ludoo.enum.shape import WD_INLINE_SHAPE
from docx_fork_ludoo.oxml.shape import CT_Inline, CT_Picture
from docx_fork_ludoo.oxml.shared import nsmap
...
class InlineShape(object):
    ...
    def type(self):
        ...
        ``docx_fork_ludoo.enum.shape.WD_INLINE_SHAPE``, e.g. ``LINKED_PICTURE``.
        Read-only.
        """
