...
"""
Text-related proxy types for python-docx_fork_ludoo, such as Paragraph and Run.
"""

from __future__ import absolute_import, print_function, unicode_literals

from docx_fork_ludoo.oxml.text import CT_RPr, CT_Text, CT_Br, CT_Tab
from docx_fork_ludoo.oxml.parts.notes import CT_EndnoteReference, CT_FootnoteReference
...
class Run(object):
    ...
    def add_break(self, break_type=WD_BREAK.LINE):
        ...
        `WD_BREAK.COLUMN` where `WD_BREAK` is imported from `docx_fork_ludoo.enum.text`.
