...
from docx_fork_ludoo.oxml.shared import register_custom_element_class
...
from docx_fork_ludoo.oxml.shared import CT_DecimalNumber, CT_OnOff, CT_String

from docx_fork_ludoo.oxml.shape import (
...
from docx_fork_ludoo.oxml.parts.document import CT_Body, CT_Document
register_custom_element_class('w:body', CT_Body)
register_custom_element_class('w:document', CT_Document)

from docx_fork_ludoo.oxml.parts.numbering import (
...
from docx_fork_ludoo.oxml.parts.styles import CT_Style, CT_Styles
register_custom_element_class('w:style', CT_Style)
register_custom_element_class('w:styles', CT_Styles)

from docx_fork_ludoo.oxml.parts.notes import CT_Endnotes, CT_Footnotes, CT_Note, CT_EndnoteReference, CT_FootnoteReference
...
from docx_fork_ludoo.oxml.table import CT_Row, CT_Tbl, CT_TblGrid, CT_TblPr, CT_Tc
...
from docx_fork_ludoo.oxml.text import (
