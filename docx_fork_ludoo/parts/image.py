...
from docx_fork_ludoo.opc.package import Part
from docx_fork_ludoo.shared import Emu, Inches
...
class ImagePart(Part):
    ...
    def load(cls, partname, content_type, blob, package):
        """
        Called by ``docx_fork_ludoo.opc.package.PartFactory`` to load an image part from
