...
% Stam font
% shorten polythumbs - they are overlapping text, in later chapters    - changed in polythumbs.sty, haven't checked the result yet
...
\newcommand{\mybookname}[2]{
    ...
    \addtokomafont{part}{\fontsize{34}{34}\hebrewfontnarkisim}    
    \part[#2]{#1}
