...
% avoid splitting a footnote to 2 pages
% default value is 100; lot of splits
% value of 10000 completely avoid splitting (according to chatgpt),
% which might cause too many blank spaces
