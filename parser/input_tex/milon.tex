...
% Reduced stretch from 0.5pt to 0.1pt and from 0.05ex to 0.01ex (2025-11-02).
%
% How this works together with columnbadness above:
% 1. Less stretch available → Balancing requires higher badness sooner
% 2. columnbadness=500 → Rejects solutions with badness > 500
% 3. Result: multicol gives up on balancing more often, producing unbalanced columns
%    instead of ugly spacing
%
% Tuning guide:
% - If still too much stretching: reduce to 0.05pt and 0.005ex, or lower columnbadness
% - If too many unbalanced columns: increase to 0.5pt and 0.05ex, or raise columnbadness
% - Note: "plus 0.25pt" doesn't mean "max 0.25pt stretch" - TeX can stretch infinitely,
...
\newcommand{\paragraphs}{
    \par\vspace{1ex plus 0.025ex minus 0.01ex}
}
