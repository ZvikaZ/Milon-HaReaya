...
def parse_runs(paragraph, footnote_paragraph, debug_file): # TODO debug_file - remove
	...
	return para, size_kind, footnotes # TODO this should be changed. size_kind shouldn't be returned and moved to other functions. it makes no sence.
