...
\newcommand{\paragraphs}{
    \par\vspace{1ex plus 0.2ex minus 0.2ex}
}
...
% TODO delete this
% TODO solution of ChatGPT. maybe it's not good...
% the problems was that just defining `\newcommand{\mynewline}{\\*}` caused problems in some places
% maybe it's better solved in python?
%\newcommand{\mynewline}{\ifhmode\\*\else\relax\fi}
\newcommand{\mynewline}{
