% rejects:
% v. polythumbs - smaller, like in book
% v. Cicrles - not bold
% v. Book's title - font - not Narkisim
% v. Makaph - should be instead of `-', but solve the missing Makaph in light font   (EinSof)
% v. page `number' - end of line
% v.  page 'number' - should be smaller
% v. footnote - number under line (both single and dual digits)
% v. page 17 - Emnuna - Megamat Haemunah - missing bold
% v. Meuyan - middle of line, space before them   (page 17)
% letters' size - too big
% line spacing - smaller
% letter heading - smaller
