...
% w. Makaph - should be instead of `-', but solve the missing Makaph in light font   (EinSof)    # waiting for Rav's answer between 2 options

% letter's size - too big
% page `number' - end of line, should be smaller
% footnote - number under line (both single and dual digits)
% page 17 - Emnuna - Megamat Haemunah - missing bold
% Meuyan - middle of line, space before them   (page 17)
